...
/* jscpd:ignore-start -- local copy of the projection official ui-subagent keeps
   package-private (its /client export does not publish it), so this plugin
   carries its own instance instead of widening the official API surface. */
/**
