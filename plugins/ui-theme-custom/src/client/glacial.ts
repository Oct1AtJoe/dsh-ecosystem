...
export const GLACIAL_TOKENS: ThemeTokens = Object.freeze({
  ...
  '--dsw-alias-bg-app-image':
    'linear-gradient(180deg, rgba(150, 210, 245, 0.08), rgba(150, 210, 245, 0) 24%),'
