...
export const NEBULA_TOKENS = Object.freeze({
    ...
    '--dsw-alias-bg-app-image': 'linear-gradient(180deg, rgba(148, 163, 255, 0.1), rgba(148, 163, 255, 0) 26%),'
    ...
    '--dsw-alias-button-glow': 'inset 0 1px 0 rgba(255, 255, 255, 0.3), 0 0 0 1px rgba(168, 190, 255, 0.3),'
        + '0 0 18px rgba(104, 118, 255, 0.45), 0 8px 28px rgba(91, 106, 245, 0.4)',
    '--dsw-alias-button-glow-hover': 'inset 0 1px 0 rgba(255, 255, 255, 0.4), 0 0 0 1px rgba(196, 210, 255, 0.45),'
        + '0 0 24px rgba(122, 144, 255, 0.6), 0 12px 36px rgba(104, 118, 255, 0.55)',
    '--dsw-alias-button-press-shadow': 'inset 0 1px 0 rgba(255, 255, 255, 0.18), 0 0 0 1px rgba(168, 190, 255, 0.18),'
        + '0 4px 12px rgba(91, 106, 245, 0.25)',
    '--dsw-alias-button-press-shift': 'translate(0, 1px)',
    '--dsw-alias-button-outline-glow': 'inset 0 1px 0 rgba(255, 255, 255, 0.22), 0 0 0 1px rgba(168, 190, 255, 0.32),'
