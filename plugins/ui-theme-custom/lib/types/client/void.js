...
export const VOID_TOKENS = Object.freeze({
    ...
    '--dsw-alias-button-glow-hover': 'inset 0 1px 0 rgba(255, 255, 255, 0.32), 0 0 0 1px rgba(210, 208, 218, 0.34),'
        + '0 0 18px rgba(184, 182, 194, 0.36), 0 12px 36px rgba(148, 146, 158, 0.32)',
    '--dsw-alias-button-press-shadow': 'inset 0 1px 0 rgba(255, 255, 255, 0.12), 0 0 0 1px rgba(196, 194, 202, 0.12),'
        + '0 4px 12px rgba(134, 132, 144, 0.14)',
    '--dsw-alias-button-press-shift': 'translate(0, 1px)',
    '--dsw-alias-button-outline-glow': 'inset 0 1px 0 rgba(255, 255, 255, 0.16), 0 0 0 1px rgba(196, 194, 202, 0.24),'
