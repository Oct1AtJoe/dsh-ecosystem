import { SEQUOIA_TOKENS } from "./sequoia.js";
import { SONOMA_TOKENS } from "./sonoma.js";
...
body[data-ds-custom-theme]{
  ...
  /* 浮层（菜单/提示）单列一档：对齐 t3 黄金通透档位（.38），强高斯模糊彻底化开背景，极致通透 */
  --dsh-glass-popover-fill:rgba(255,255,255,0.38);
}
