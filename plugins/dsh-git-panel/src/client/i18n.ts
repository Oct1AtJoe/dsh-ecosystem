...
const DICTS: Record<Lang, Dict> = {
  ...
  es: {
    ...
    'write.stash.tip': 'Guarda todos los cambios sin confirmar, incluidos los archivos nuevos sin seguimiento, en el stash (git stash push -u) y deja el árbol de trabajo limpio. NO es lo mismo que preparar (git add).',
    ...
    'write.status': 'Estado',
    'write.status.tip': 'Vuelve a leer git status y el guardado, y actualiza la pantalla (no toca el árbol de trabajo)',
    'op.ok': 'Hecho',
    ...
    'changes.mark.untracked': 'Sin seguimiento (archivo nuevo, aún no en git — no se confirma si no se prepara)',
    'changes.mark.modified': 'Modificado',
    'changes.mark.added': 'Añadido (preparado)',
